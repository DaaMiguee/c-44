...
import { getUserData, checkAdmin, publicAcces, privateAcces, manageProducts, checkAdminSession, checkRole, checkAndCreateCart} from '../middlewares/middlewares.js'
...
router.get('/uploaddocuments', getUserData, viewController.uploadDocuments)
